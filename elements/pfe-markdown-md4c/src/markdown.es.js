...
"undefined" != typeof module && ((u = module), (module = void 0)),
  ((s = { preRun: [], postRun: [], print: console.log.bind(console), printErr: console.error.bind(console) }).ready =
    new Promise((u) => {
      s.onRuntimeInitialized = () => {
        (s.___wasm_call_ctors = e = s.asm.c),
          (s._wrealloc = n = s.asm.d),
          (s._wfree = t = s.asm.e),
          (s._WErrGetCode = r = s.asm.f),
          (s._WErrGetMsg = o = s.asm.g),
          (s._WErrClear = i = s.asm.h),
          (s._parseUTF8 = a = s.asm.i),
          u({});
      };
    })),
  q &&
    k &&
    (s.locateFile = function (e) {
      console.log("locateFile", k.join(__dirname, e));
...
m
  ? ((h = __dirname + "/"),
    (w = function (e, n) {
      return (
        b || (b = require("fs")), E || (E = require("path")), (e = E.normalize(e)), b.readFileSync(e, n ? null : "utf8")
      );
    }),
    (A = function (e) {
      var n = w(e, !0);
  ...
  ? ("undefined" != typeof read &&
    ...
    void 0 !== G &&
      ...
      (console.log = G),
      (console.warn = console.error = "undefined" != typeof printErr ? printErr : G)))
  : (d || p) &&
    (p ? (h = self.location.href) : document.currentScript && (h = document.currentScript.src),
...
f))
  f.hasOwnProperty(c) && (s[c] = f[c]);
function z(e, n) {
  return e % n > 0 && (e += n - (e % n)), e;
}
function Y(e) {
  (R = e),
    (s.HEAP8 = I = new Int8Array(e)),
    (s.HEAP16 = new Int16Array(e)),
    (s.HEAP32 = L = new Int32Array(e)),
    (s.HEAPU8 = v = new Uint8Array(e)),
...
function $(e) {
  for (var n, t; e.length > 0; )
    "function" != typeof (n = e.shift())
      ? "number" == typeof (t = n.func)
        ? void 0 === n.arg
          ? s.dynCall_v(t)
          : s.dynCall_vi(t, n.arg)
...
if (
  ((f = null),
  s.arguments && (l = s.arguments),
  s.thisProgram && s.thisProgram,
  s.quit && s.quit,
  s.wasmBinary && (g = s.wasmBinary),
  s.noExitRuntime && s.noExitRuntime,
  "object" != typeof WebAssembly && V("no native wasm support detected"),
  (T = new WebAssembly.Table({ initial: 8, maximum: 8, element: "anyfunc" })),
  (S = !1),
  ...
  5251216,
  8176,
  (M = s.TOTAL_MEMORY || 16777216),
  (_ = s.wasmMemory ? s.wasmMemory : new WebAssembly.Memory({ initial: M / 65536 })) && (R = _.buffer),
  (M = R.byteLength),
  Y(R),
  (L[2044] = 5251216),
  (U = []),
  ...
  J((N = "markdown.wasm")) || ((j = N), (N = s.locateFile ? s.locateFile(j, h) : h + j)),
  H.push({
    func: function () {
      e();
    },
  ...
  (B = {
    ...
    b: function (e) {
      ...
      for (16777216, n = Math.max(t, 16777216); n < e; )
        n = n <= 536870912 ? z(2 * n, 65536) : Math.min(z((3 * n + 2147483648) / 4, 65536), 2147418112);
      return !!(function (e) {
        try {
  ...
  (C = (function () {
    ...
    function n(e, n) {
      ...
      (s.asm = t),
        (function (e) {
          if (
            (x--,
            s.monitorRunDependencies && s.monitorRunDependencies(x),
            0 == x && (null !== O && (clearInterval(O), (O = null)), D))
          ) {
            var n = D;
            (D = null), n();
          }
    ...
    if ((x++, s.monitorRunDependencies && s.monitorRunDependencies(x), s.instantiateWasm))
      try {
    ...
    return (
      (function () {
        if (g || "function" != typeof WebAssembly.instantiateStreaming || J(N) || "function" != typeof fetch)
          return r(t);
        fetch(N, { credentials: "same-origin" }).then(function (n) {
...
export { te as ready, re as ParseFlags, ie as parse };
