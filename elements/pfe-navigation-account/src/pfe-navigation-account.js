...
class PfeNavigationAccount extends PFElement {
  ...
  constructor() {
    ...
    this._processUserMenuReady = this._processUserMenuReady(this);
    ...
    // Set pfe-navigation-account-ready attribute when user menu is ready
    this._processUserMenuReady;
  }
  ...
  /**
   * Process if user menu is ready
   * add pfe-navigation-account-ready attribute to component
   */
  _processUserMenuReady() {
    this.setAttribute("pfe-navigation-account-ready", "");
  }
}
